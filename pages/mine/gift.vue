<template>
	...
	<view class="px-4">
		...
		<u-navbar bgColor="transparent" :safeAreaInsetTop="true" :placeholder="true">
			<view slot="left">
				<i class="ri-arrow-left-s-line text-4xl text-black" @click='backPage'></i>
			</view>
			<view slot="center">
				<view class="text-black" style="font-size: 36rpx;" @click="skipGifts">我的礼物</view>
			</view>
			<!-- 	<view slot="right">
		...
		<u-empty v-if="!listUserGift.length" icon="/static/empty.png" text="数据为空" textColor="#a1a1a1"
