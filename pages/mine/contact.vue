<template>
	...
	<view class="px-4">
		<u-navbar :safeAreaInsetTop="true" :placeholder="true">
			...
			<view slot="center">
				<u-tabs :list="tablist" lineColor="rgba(255, 0, 0, 0.2)" lineWidth="70rpx" lineHeight="16rpx"
					...
					activeStyle="color: #333333; font-weight: blod; transform: scale(1.2);" @change="changeTab" @click="click">
				</u-tabs>
			</view>
		...
		<u-empty v-if="!listUserFollow.length" icon="/static/null.png" text="数据为空" textColor="#a1a1a1"
