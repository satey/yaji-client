<template>
    ...
    <view class="">
        ...
        <view class="fixed bottom-0  left-0 right-0 !border-t border-0 border-solid border-gray-100 bg-white"  :style="{bottom:pageHeight+'px'}" >
			<view class="flex p-4">
                ...
                <view class="flex-1 mr-4 rounded-full h-10 flex items-center px-4 bg-gray-100">
                    <u-input v-model="text" @focus="focus" @blur="blur" :adjust-position="false" style="" @confirm="handleTextSend" type="text" placeholder="说点什么吧" :clearable="true" customStyle="border: none; background: none; padding: 0;">
                    </u-input>
                </view>
            ...
            uni.uploadFile({
                ...
                success: res => {
                    ...
                    if (res.code === 1) {
						...
						console.log('res.data.fullurl',res.data.fullurl);
                    } else {
                        that.$u.toast(res.msg)
                    }
                },
