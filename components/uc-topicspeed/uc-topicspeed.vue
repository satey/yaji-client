<template>
	<view>
		<view class="topic-item"  >
			...
			<!-- <view class="chenghao" v-show="roleTotalList.length>0" v-for="items in roleTotalList">{{item.user.role_titles}} </view> -->
			...
			<view class="total">
				...
				<view class="" style="display: inline-block;" @click="handlePostDig()">
					<i style="margin-left: 25rpx;"  v-show='is_zan==0'class="ri-heart-3-fill text-l bg-gradient-to-b from-gray-300 to-gray-200 bg-clip-text text-transparent ;"></i>
					<i  style="margin-left: 25rpx;"  v-show='is_zan==1' class="ri-heart-3-fill text-l bg-gradient-to-b from-red-400 to-red-400 bg-clip-text text-transparent"></i>
					<view class="" style="font-size: 24rpx; display: inline-block;position: relative; top: -5rpx;left: 10rpx;" v-show="item.diggnums>0">{{ item.diggnums }}</view>
					<view class="" style="font-size: 24rpx; display: inline-block;position: relative; top: -5rpx;left: 10rpx;" v-show="item.diggnums<=0">出彩</view>
				</view>
				<view class="" style="display: inline-block;" @click="handleConcleDig()">
					<image  v-show='is_cai==0' src="../../static/nolove.png" style="width: 30rpx; margin-left: 30rpx; margin-top: 10rpx; height: 30rpx;" mode=""></image>
					<image v-show='is_cai==1' src="../../static/nolove-red.png" style="width: 30rpx;margin-left: 30rpx; margin-top: 10rpx;height: 30rpx;" mode=""></image>
