<template>
	...
	<view class="flex mt-8" :class="[item.is_free==0?'':'active']" style="margin-top: 80rpx;">
		<!-- {{item}} -->
		...
		<view
			...
			<!-- {{item.is_free}} -->
			<view class="ml-4" :class="[item.is_free==0?'':'active']" style="display: flex;align-items: center;">
