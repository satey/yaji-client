		...
		<view>
			<block v-for="(item,index) in commentList" :key="index">
				<view class="commentItem">
					<image class="commentUserImg" :src="item.user_info.avatar" mode="aspectFill"></image>
					<view style="flex: 1;">
						...
						<block v-if="item.oldCommentArr.length!=0">
							<view style="width: 100%;box-sizing: border-box;"
								...
								<view class="commentItem">
									<image class="commentUserImg" style="width: 56rpx;height: 56rpx;"
										:src="oldItem.user_info.avatar" mode="aspectFill">
									</image>
									<view style="flex: 1;">
										<view style="display: flex;align-items: center;justify-content: space-between;">
										...
										<view class="commentContent">{{oldItem.content}}</view>
										<view>
											<text
